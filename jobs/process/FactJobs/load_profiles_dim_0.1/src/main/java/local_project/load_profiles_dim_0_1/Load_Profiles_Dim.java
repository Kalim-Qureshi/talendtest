...
package local_project.load_profiles_dim_0_1;
...
/**
 * Job: Load_Profiles_Dim Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class Load_Profiles_Dim implements TalendJob {
...
public String getCassandra_Username(){
	...
	private final String jobName = "Load_Profiles_Dim";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Load_Profiles_Dim.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Load_Profiles_Dim.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tCassandraInput_2_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tCassandraInput_2_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class row_Implicit_Context_RegexStruct implements routines.system.IPersistableRow<row_Implicit_Context_RegexStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_Load_Profiles_Dim = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_Load_Profiles_Dim = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_Load_Profiles_Dim.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_Load_Profiles_Dim.length == 0) {
   					commonByteArray_LOCAL_PROJECT_Load_Profiles_Dim = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_Load_Profiles_Dim = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_Load_Profiles_Dim, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_Load_Profiles_Dim, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_Load_Profiles_Dim) {
...
topology_tDBRow_3 = org.talend.components.api.component.ConnectorTopology.INCOMING;
...
if(componentRuntime_tDBRow_3 instanceof org.talend.components.api.component.runtime.SourceOrSink) {
    ...
    org.talend.components.api.component.runtime.Sink sink_tDBRow_3 =
            (org.talend.components.api.component.runtime.Sink)sourceOrSink_tDBRow_3;
    org.talend.components.api.component.runtime.WriteOperation writeOperation_tDBRow_3 = sink_tDBRow_3.createWriteOperation();
    writeOperation_tDBRow_3.initialize(container_tDBRow_3);
    org.talend.components.api.component.runtime.Writer writer_tDBRow_3 = writeOperation_tDBRow_3.createWriter(container_tDBRow_3);
    writer_tDBRow_3.open("tDBRow_3");

    resourceMap.put("writer_tDBRow_3", writer_tDBRow_3);

    org.talend.components.api.component.Connector c_tDBRow_3 = null;
    for (org.talend.components.api.component.Connector currentConnector : props_tDBRow_3.getAvailableConnectors(null, false)) {
        if (currentConnector.getName().equals("MAIN")) {
            c_tDBRow_3 = currentConnector;
            break;
        }
    }
    org.apache.avro.Schema designSchema_tDBRow_3 = props_tDBRow_3.getSchema(c_tDBRow_3, false);
    org.talend.codegen.enforcer.IncomingSchemaEnforcer incomingEnforcer_tDBRow_3
            = new org.talend.codegen.enforcer.IncomingSchemaEnforcer(designSchema_tDBRow_3);
...
org.talend.components.jdbc.tjdbcinput.TJDBCInputProperties props_tDBInput_2 =
        (org.talend.components.jdbc.tjdbcinput.TJDBCInputProperties) def_tDBInput_2.createRuntimeProperties();
 		                    ...
 		                    "SELECT DATE_PART('EPOCH_MILLISECOND',CollectionstartDate) AS CollectionstartDate_Epoch,  DATE_PART('EPOCH_MILLISECOND',CollectionEndDate) AS CollectionEndDate_Epoch,  CollectionstartDate AS CollectionstartDate, CollectionEndDate AS CollectionEndDate from STG.DATA_COLLECTION Where LoadType = 'Load_Profile_Risk_Data' AND STAGING_SRC_LOADED =FALSE");
 		                    ...
 		                    java.util.List<Object> tDBInput_2_trimTable_columnName = new java.util.ArrayList<Object>();
 		                            ...
 		                            tDBInput_2_trimTable_columnName.add("CollectionstartDate_Epoch");
 		                            
 		                            tDBInput_2_trimTable_columnName.add("CollectionEndDate_Epoch");
    ...
    for (; available_tDBInput_2; available_tDBInput_2 = reader_tDBInput_2.advance()) {
        ...
        outgoingEnforcer_tDBInput_2.setWrapped(factory_tDBInput_2.convertToAvro(data_tDBInput_2));
                Object columnValue_0_tDBInput_2 = outgoingEnforcer_tDBInput_2.get(0);
                        row3.CollectionstartDate_Epoch = (Long) (columnValue_0_tDBInput_2);
                Object columnValue_1_tDBInput_2 = outgoingEnforcer_tDBInput_2.get(1);
                        row3.CollectionEndDate_Epoch = (Long) (columnValue_1_tDBInput_2);
                Object columnValue_2_tDBInput_2 = outgoingEnforcer_tDBInput_2.get(2);
                        row3.CollectionstartDate = (java.util.Date) (columnValue_2_tDBInput_2);
                Object columnValue_3_tDBInput_2 = outgoingEnforcer_tDBInput_2.get(3);
                        row3.CollectionEndDate = (java.util.Date) (columnValue_3_tDBInput_2);
...
globalMap.put("JobID",89);
globalMap.put("TableName","Dim_SEC_Profile");
 ...
 */
	...
	currentComponent="tDBRow_3";
            ...
            incomingEnforcer_tDBRow_3.createNewRecord();
 		                    props_tDBRow_3.setValue("sql",
 		                    "Update STG.Job_Control  SET JobStartDate=CONVERT_TIMEZONE('US/Pacific','UTC',cast(CURRENT_TIMESTAMP() as TIMESTAMP_NTZ)), JobEndDate=NULL, DURATION=NULL WHERE JOBID="+globalMap.get("JobID"));
 		                    
            org.apache.avro.generic.IndexedRecord data_tDBRow_3 = incomingEnforcer_tDBRow_3.getCurrentRecord();
            

            writer_tDBRow_3.write(data_tDBRow_3);
...
resourceMap.put("finish_tDBRow_3", Boolean.TRUE);
    ...
    org.talend.components.api.component.runtime.Result resultObject_tDBRow_3 = (org.talend.components.api.component.runtime.Result)writer_tDBRow_3.close();
    final java.util.Map<String, Object> resultMap_tDBRow_3 = writer_tDBRow_3.getWriteOperation().finalize(java.util.Arrays.<org.talend.components.api.component.runtime.Result>asList(resultObject_tDBRow_3), container_tDBRow_3);
...
if(resourceMap.get("finish_tDBRow_3")==null){
    if(resourceMap.get("writer_tDBRow_3")!=null){
		try {
			((org.talend.components.api.component.runtime.Writer)resourceMap.get("writer_tDBRow_3")).close();
...
public void tCassandraInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
...
org.talend.components.jdbc.tjdbcoutput.TJDBCOutputProperties props_tDBOutput_1 =
        (org.talend.components.jdbc.tjdbcoutput.TJDBCOutputProperties) def_tDBOutput_1.createRuntimeProperties();
 		                    ...
 		                    props_tDBOutput_1.main.setValue("schema",
 		                        new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"tDBOutput_1\",\"fields\":[{\"name\":\"profile_id\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"profile_id\",\"talend.field.dbType\":\"uuid\",\"talend.field.dbColumnName\":\"profile_id\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"profile_id\",\"talend.field.isKey\":\"true\",\"di.column.relatedEntity\":\"\"},{\"name\":\"profile_name\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"profile_name\",\"talend.field.dbType\":\"text\",\"talend.field.dbColumnName\":\"profile_name\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"profile_name\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tDBOutput_1\",\"di.table.label\":\"tDBOutput_1\"}"));
 		                    
 		                    props_tDBOutput_1.schemaFlow.setValue("schema",
 		                        new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"tDBOutput_1\",\"fields\":[{\"name\":\"profile_id\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"profile_id\",\"talend.field.dbType\":\"uuid\",\"talend.field.dbColumnName\":\"profile_id\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"profile_id\",\"talend.field.isKey\":\"true\",\"di.column.relatedEntity\":\"\"},{\"name\":\"profile_name\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"profile_name\",\"talend.field.dbType\":\"text\",\"talend.field.dbColumnName\":\"profile_name\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"profile_name\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tDBOutput_1\",\"di.table.label\":\"tDBOutput_1\"}"));
 		                    
 		                    props_tDBOutput_1.schemaReject.setValue("schema",
 		                        new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"rejectOutput\",\"fields\":[{\"name\":\"profile_id\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"profile_id\",\"talend.field.dbType\":\"uuid\",\"talend.field.dbColumnName\":\"profile_id\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"profile_id\",\"talend.field.isKey\":\"true\",\"di.column.relatedEntity\":\"\"},{\"name\":\"profile_name\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"profile_name\",\"talend.field.dbType\":\"text\",\"talend.field.dbColumnName\":\"profile_name\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"profile_name\",\"di.column.relatedEntity\":\"\"},{\"name\":\"errorCode\",\"type\":\"string\",\"talend.isLocked\":\"false\",\"talend.field.generated\":\"true\",\"talend.field.length\":\"255\"},{\"name\":\"errorMessage\",\"type\":\"string\",\"talend.isLocked\":\"false\",\"talend.field.generated\":\"true\",\"talend.field.length\":\"255\"}],\"di.table.name\":\"tDBOutput_1\",\"di.table.label\":\"tDBOutput_1\"}"));
 		                    ...
 		                    java.util.List<Object> tDBOutput_1_fieldOptions_schemaColumns = new java.util.ArrayList<Object>();
 		                            ...
 		                            tDBOutput_1_fieldOptions_schemaColumns.add("profile_id");
 		                            
 		                            tDBOutput_1_fieldOptions_schemaColumns.add("profile_name");
 ...
 */
	...
	currentComponent="tCassandraInput_2";
        ...
        com.datastax.driver.core.Cluster cluster_tCassandraInput_2 = (com.datastax.driver.core.Cluster)globalMap.get("cluster_tCassandraConnection_1");
    	com.datastax.driver.core.Session connection_tCassandraInput_2 = (com.datastax.driver.core.Session)globalMap.get("connection_tCassandraConnection_1");
	
	com.datastax.driver.core.ResultSet rs_tCassandraInput_2 = connection_tCassandraInput_2.execute("Select \"ID\" AS profile_id, \"Name\" AS profile_name FROM profiling_service_db.profiles;");
	int nb_line_tCassandraInput_2 = 0;
	for(com.datastax.driver.core.Row row_tCassandraInput_2 : rs_tCassandraInput_2){
			if(row_tCassandraInput_2.isNull("\"profile_id\"")){
				row1.profile_id = null;
			}else{
				
	    				row1.profile_id = row_tCassandraInput_2.getUUID("\"profile_id\"").toString();
	    			
	    	}		
	    
			if(row_tCassandraInput_2.isNull("\"profile_name\"")){
				row1.profile_name = null;
			}else{
				
	    				row1.profile_name = row_tCassandraInput_2.getString("\"profile_name\"");
 ...
 */
	...
	currentComponent="tDBOutput_1";
            ...
            incomingEnforcer_tDBOutput_1.createNewRecord();
                    incomingEnforcer_tDBOutput_1.put("profile_id", row1.profile_id);
                    incomingEnforcer_tDBOutput_1.put("profile_name", row1.profile_name);
 ...
 */
    ...
    public static void main(String[] args){
        final Load_Profiles_Dim Load_Profiles_DimClass = new Load_Profiles_Dim();

        int exitCode = Load_Profiles_DimClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Load_Profiles_Dim.class.getClassLoader().getResourceAsStream("local_project/load_profiles_dim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Load_Profiles_Dim.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Load_Profiles_Dim");
        }
...
/************************************************************************************************
 *     264899 characters generated by Talend Open Studio for Big Data 
 *     on the June 27, 2018 12:38:18 PM IST
 ************************************************************************************************/