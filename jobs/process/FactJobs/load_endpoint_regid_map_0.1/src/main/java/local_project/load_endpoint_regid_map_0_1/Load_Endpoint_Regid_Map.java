...
package local_project.load_endpoint_regid_map_0_1;
...
/**
 * Job: Load_Endpoint_Regid_Map Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class Load_Endpoint_Regid_Map implements TalendJob {
...
public String getStoragePath(){
	...
	private final String jobName = "Load_Endpoint_Regid_Map";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Load_Endpoint_Regid_Map.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Load_Endpoint_Regid_Map.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tCassandraConnection_1_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tCassandraConnection_1_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class row_Implicit_Context_RegexStruct implements routines.system.IPersistableRow<row_Implicit_Context_RegexStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_Load_Endpoint_Regid_Map = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_Load_Endpoint_Regid_Map = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_Load_Endpoint_Regid_Map.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_Load_Endpoint_Regid_Map.length == 0) {
   					commonByteArray_LOCAL_PROJECT_Load_Endpoint_Regid_Map = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_Load_Endpoint_Regid_Map = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_Load_Endpoint_Regid_Map, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_Load_Endpoint_Regid_Map, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_Load_Endpoint_Regid_Map) {
 ...
 */
    ...
    com.datastax.driver.core.Cluster cluster_tCassandraConnection_1 = com.datastax.driver.core.Cluster.builder()
...
globalMap.put("JobID", 93);
globalMap.put("TableName", "SEC_Endpoint_RegId_Map");
...
java.io.File file_tFileOutputJSON_1 = new java.io.File(context.StoragePath+"/"+globalMap.get("TableName")+"/out.json");
...
java.io.PrintWriter outtFileOutputJSON_1 = new java.io.PrintWriter(new java.io.BufferedWriter(new java.io.FileWriter(context.StoragePath+"/"+globalMap.get("TableName")+"/out.json")));
 ...
 */
	...
	currentComponent="tCassandraInput_1";
        ...
        com.datastax.driver.core.Cluster cluster_tCassandraInput_1 = (com.datastax.driver.core.Cluster)globalMap.get("cluster_tCassandraConnection_1");
    	com.datastax.driver.core.Session connection_tCassandraInput_1 = (com.datastax.driver.core.Session)globalMap.get("connection_tCassandraConnection_1");
	
	com.datastax.driver.core.ResultSet rs_tCassandraInput_1 = connection_tCassandraInput_1.execute("Select endpoint_id AS endpointid,legacy_reg_id as regid from platform_agent_db.provisioning_details;");
	...
	for(com.datastax.driver.core.Row row_tCassandraInput_1 : rs_tCassandraInput_1){
			if(row_tCassandraInput_1.isNull("\"endpointid\"")){
				row1.endpointid = null;
	    				...
	    				row1.endpointid = row_tCassandraInput_1.getString("\"endpointid\"");
	    			
	    	}		
	    
			if(row_tCassandraInput_1.isNull("\"regid\"")){
				row1.regid = null;
			}else{
				
	    				row1.regid = row_tCassandraInput_1.getString("\"regid\"");
...
org.json.simple.JSONObject jsonRowtFileOutputJSON_1 = new org.json.simple.JSONObject();
			    	if(row1.endpointid != null){
			    
					jsonRowtFileOutputJSON_1.put("endpointid", row1.endpointid);
				
					}else{
						jsonRowtFileOutputJSON_1.put("endpointid", null);
					}
				
			    	if(row1.regid != null){
			    
					jsonRowtFileOutputJSON_1.put("regid", row1.regid);
				
					}else{
						jsonRowtFileOutputJSON_1.put("regid", null);
					}
 ...
 */
	...
	currentComponent="tFileArchive_1";
		...
		String sourceFile_tFileArchive_1 = context.StoragePath+"/"+globalMap.get("TableName")+"/out.json";
	
    String zipFile_tFileArchive_1 = context.StoragePath+"/"+globalMap.get("TableName")+"/out.json.gz";
...
org.talend.components.jdbc.tjdbcrow.TJDBCRowProperties props_tDBRow_5 =
        (org.talend.components.jdbc.tjdbcrow.TJDBCRowProperties) def_tDBRow_5.createRuntimeProperties();
 		                    ...
 		                    "put file://"+context.StoragePath+"/"+globalMap.get("TableName")+"/out.json.gz  @~/"+globalMap.get("TableName")+"_JSON");
...
org.talend.components.jdbc.tjdbcrow.TJDBCRowProperties props_tDBRow_6 =
        (org.talend.components.jdbc.tjdbcrow.TJDBCRowProperties) def_tDBRow_6.createRuntimeProperties();
 		                    ...
 		                    "TRUNCATE TABLE SRC."+globalMap.get("TableName")+"_JSON");
...
org.talend.components.jdbc.tjdbcrow.TJDBCRowProperties props_tDBRow_7 =
        (org.talend.components.jdbc.tjdbcrow.TJDBCRowProperties) def_tDBRow_7.createRuntimeProperties();
 		                    props_tDBRow_7.setValue("sql",
 		                    "COPY INTO SRC."+globalMap.get("TableName")+"_JSON  FROM  @~/"+globalMap.get("TableName")+"_JSON  FILE_FORMAT = 'STG.JSON_FF'   ON_ERROR = 'ABORT_STATEMENT' PURGE = TRUE");
 		                    
 		                    props_tDBRow_7.setValue("dieOnError",
 		                    false);
 		                    
 		                    props_tDBRow_7.setValue("propagateQueryResultSet",
 		                    false);
 		                    
 		                    props_tDBRow_7.setValue("usePreparedStatement",
 		                    false);
 		                    
 		                    props_tDBRow_7.referencedComponent.setValue("referenceType",
 		                        org.talend.components.api.properties.ComponentReferenceProperties.ReferenceType.COMPONENT_INSTANCE);
 		                    
 		                    props_tDBRow_7.referencedComponent.setValue("componentInstanceId",
 		                    "tJDBCConnection_2");
 		                    
 		                    props_tDBRow_7.referencedComponent.setValue("referenceDefinitionName",
 		                    "tJDBCConnection");
 		                    
 		                    props_tDBRow_7.connection.userPassword.setValue("useAuth",
 		                    false);
 		                    
 		                    props_tDBRow_7.main.setValue("schema",
 		                        new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EmptyRecord\",\"fields\":[]}"));
 		                    ...
 		                    props_tDBRow_7.tableSelection.setValue("tablename",
 		                    "");
 		                    
 		                    props_tDBRow_7.preparedStatementTable.setValue("types",
 		                    "BigDecimal");
 		                    
    if (org.talend.components.api.properties.ComponentReferenceProperties.ReferenceType.COMPONENT_INSTANCE == props_tDBRow_7.referencedComponent.referenceType.getValue()) {
        final String referencedComponentInstanceId_tDBRow_7 = props_tDBRow_7.referencedComponent.componentInstanceId.getStringValue();
        if (referencedComponentInstanceId_tDBRow_7 != null) {
            ...
            props_tDBRow_7.referencedComponent.setReference(referencedComponentProperties_tDBRow_7);
        }
    }
...
org.talend.components.jdbc.tjdbcrow.TJDBCRowProperties props_tDBRow_8 =
        (org.talend.components.jdbc.tjdbcrow.TJDBCRowProperties) def_tDBRow_8.createRuntimeProperties();
 		                    ...
 		                    "TRUNCATE TABLE SRC."+globalMap.get("TableName")+"_STG");
...
org.talend.components.jdbc.tjdbcrow.TJDBCRowProperties props_tDBRow_9 =
        (org.talend.components.jdbc.tjdbcrow.TJDBCRowProperties) def_tDBRow_9.createRuntimeProperties();
 		                    props_tDBRow_9.setValue("sql",
 		                    "INSERT INTO SRC.SEC_Endpoint_RegId_Map_STG(EndpointId,RegId) SELECT  SRC:endpointid::NVARCHAR(200) AS EndpointId, TRY_CAST(SRC:regid::NVARCHAR AS BIGINT) AS RegId FROM SRC.SEC_Endpoint_RegId_Map_JSON");
 		                    
 		                    props_tDBRow_9.setValue("dieOnError",
 		                    false);
 		                    
 		                    props_tDBRow_9.setValue("propagateQueryResultSet",
 		                    false);
 		                    
 		                    props_tDBRow_9.setValue("usePreparedStatement",
 		                    false);
 		                    
 		                    props_tDBRow_9.referencedComponent.setValue("referenceType",
 		                        org.talend.components.api.properties.ComponentReferenceProperties.ReferenceType.COMPONENT_INSTANCE);
 		                    
 		                    props_tDBRow_9.referencedComponent.setValue("componentInstanceId",
 		                    "tJDBCConnection_2");
 		                    
 		                    props_tDBRow_9.referencedComponent.setValue("referenceDefinitionName",
 		                    "tJDBCConnection");
 		                    
 		                    props_tDBRow_9.connection.userPassword.setValue("useAuth",
 		                    false);
 		                    
 		                    props_tDBRow_9.main.setValue("schema",
 		                        new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EmptyRecord\",\"fields\":[]}"));
 		                    ...
 		                    props_tDBRow_9.tableSelection.setValue("tablename",
 		                    "");
 		                    
 		                    props_tDBRow_9.preparedStatementTable.setValue("types",
 		                    "BigDecimal");
 		                    
    if (org.talend.components.api.properties.ComponentReferenceProperties.ReferenceType.COMPONENT_INSTANCE == props_tDBRow_9.referencedComponent.referenceType.getValue()) {
        final String referencedComponentInstanceId_tDBRow_9 = props_tDBRow_9.referencedComponent.componentInstanceId.getStringValue();
        if (referencedComponentInstanceId_tDBRow_9 != null) {
            ...
            props_tDBRow_9.referencedComponent.setReference(referencedComponentProperties_tDBRow_9);
        }
    }
...
org.talend.components.jdbc.tjdbcrow.TJDBCRowProperties props_tDBRow_10 =
        (org.talend.components.jdbc.tjdbcrow.TJDBCRowProperties) def_tDBRow_10.createRuntimeProperties();
 		                    ...
 		                    "MERGE INTO PRD.SEC_Endpoint_RegId_Map P USING  ( Select DISTINCT  ENDPOINTID,CASE WHEN REGID IN ('ITSPlatform','') THEN NULL ELSE CAST(REGID AS BIGINT) END AS REGID From  "+context.SF_BI_STAGING_DatabaseName+".SRC.SEC_Endpoint_RegId_Map_STG )X	   ON  X.ENDPOINTID=P.ENDPOINTID  WHEN MATCHED THEN UPDATE SET  P.REGID=X.REGID  WHEN NOT MATCHED THEN  INSERT  (ENDPOINTID,REGID) VALUES ( ENDPOINTID, REGID )");
...
public void tChronometerStop_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	long timetChronometerStop_2;
	  	...
	  	timetChronometerStop_2 = System.currentTimeMillis() - ((Long)globalMap.get("tChronometerStart_1")).longValue();
...
org.talend.components.jdbc.tjdbcrow.TJDBCRowProperties props_tDBRow_11 =
        (org.talend.components.jdbc.tjdbcrow.TJDBCRowProperties) def_tDBRow_11.createRuntimeProperties();
 		                    props_tDBRow_11.setValue("sql",
 		                    "Update STG.Job_Control  SET  JobEndDate=CONVERT_TIMEZONE('US/Pacific','UTC',cast(CURRENT_TIMESTAMP() as TIMESTAMP_NTZ)), Status=TRUE, DURATION="+((Long)globalMap.get("tChronometerStop_2_DURATION"))/1000+ "WHERE JOBID="+globalMap.get("JobID"));
 		                    
 		                    props_tDBRow_11.setValue("dieOnError",
 		                    false);
 		                    
 		                    props_tDBRow_11.setValue("propagateQueryResultSet",
 		                    false);
 		                    
 		                    props_tDBRow_11.setValue("usePreparedStatement",
 		                    false);
 		                    
 		                    props_tDBRow_11.referencedComponent.setValue("referenceType",
 		                        org.talend.components.api.properties.ComponentReferenceProperties.ReferenceType.COMPONENT_INSTANCE);
 		                    
 		                    props_tDBRow_11.referencedComponent.setValue("componentInstanceId",
 		                    "tJDBCConnection_2");
 		                    
 		                    props_tDBRow_11.referencedComponent.setValue("referenceDefinitionName",
 		                    "tJDBCConnection");
 		                    
 		                    props_tDBRow_11.connection.userPassword.setValue("useAuth",
 		                    false);
 		                    
 		                    props_tDBRow_11.main.setValue("schema",
 		                        new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EmptyRecord\",\"fields\":[]}"));
 		                    ...
 		                    props_tDBRow_11.tableSelection.setValue("tablename",
 		                    "");
 		                    
 		                    props_tDBRow_11.preparedStatementTable.setValue("types",
 		                    "BigDecimal");
 		                    
    if (org.talend.components.api.properties.ComponentReferenceProperties.ReferenceType.COMPONENT_INSTANCE == props_tDBRow_11.referencedComponent.referenceType.getValue()) {
        final String referencedComponentInstanceId_tDBRow_11 = props_tDBRow_11.referencedComponent.componentInstanceId.getStringValue();
        if (referencedComponentInstanceId_tDBRow_11 != null) {
            ...
            props_tDBRow_11.referencedComponent.setReference(referencedComponentProperties_tDBRow_11);
        }
    }
...
org.talend.components.api.component.ComponentDefinition def_tDBRow_12 =
        new org.talend.components.jdbc.tjdbcrow.TJDBCRowDefinition();

org.talend.components.jdbc.tjdbcrow.TJDBCRowProperties props_tDBRow_12 =
        (org.talend.components.jdbc.tjdbcrow.TJDBCRowProperties) def_tDBRow_12.createRuntimeProperties();
 		                    props_tDBRow_12.setValue("sql",
 		                    ...
 		                    props_tDBRow_12.setValue("dieOnError",
 		                    false);
 		                    
 		                    props_tDBRow_12.setValue("propagateQueryResultSet",
 		                    false);
 		                    
 		                    props_tDBRow_12.setValue("usePreparedStatement",
 		                    false);
 		                    
 		                    props_tDBRow_12.referencedComponent.setValue("referenceType",
 		                        org.talend.components.api.properties.ComponentReferenceProperties.ReferenceType.COMPONENT_INSTANCE);
 		                    
 		                    props_tDBRow_12.referencedComponent.setValue("componentInstanceId",
 		                    "tJDBCConnection_2");
 		                    
 		                    props_tDBRow_12.referencedComponent.setValue("referenceDefinitionName",
 		                    "tJDBCConnection");
 		                    
 		                    props_tDBRow_12.connection.userPassword.setValue("useAuth",
 		                    false);
 		                    
 		                    props_tDBRow_12.main.setValue("schema",
 		                        new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EmptyRecord\",\"fields\":[]}"));
 		                    ...
 		                    props_tDBRow_12.tableSelection.setValue("tablename",
 		                    "");
 		                    
 		                    props_tDBRow_12.preparedStatementTable.setValue("types",
 		                    "BigDecimal");
 		                    
    if (org.talend.components.api.properties.ComponentReferenceProperties.ReferenceType.COMPONENT_INSTANCE == props_tDBRow_12.referencedComponent.referenceType.getValue()) {
        final String referencedComponentInstanceId_tDBRow_12 = props_tDBRow_12.referencedComponent.componentInstanceId.getStringValue();
        if (referencedComponentInstanceId_tDBRow_12 != null) {
            org.talend.daikon.properties.Properties referencedComponentProperties_tDBRow_12 = (org.talend.daikon.properties.Properties) globalMap.get(
                referencedComponentInstanceId_tDBRow_12 + "_COMPONENT_RUNTIME_PROPERTIES");
            props_tDBRow_12.referencedComponent.setReference(referencedComponentProperties_tDBRow_12);
        }
    }
...
org.talend.daikon.runtime.RuntimeInfo runtime_info_tDBRow_12 = def_tDBRow_12.getRuntimeInfo(
    org.talend.components.api.component.runtime.ExecutionEngine.DI, props_tDBRow_12, topology_tDBRow_12);
java.util.Set<org.talend.components.api.component.ConnectorTopology> supported_connector_topologies_tDBRow_12 = def_tDBRow_12.getSupportedConnectorTopologies();

org.talend.components.api.component.runtime.RuntimableRuntime componentRuntime_tDBRow_12 = (org.talend.components.api.component.runtime.RuntimableRuntime)(Class.forName(runtime_info_tDBRow_12.getRuntimeClassName()).newInstance());
org.talend.daikon.properties.ValidationResult initVr_tDBRow_12 = componentRuntime_tDBRow_12.initialize(container_tDBRow_12, props_tDBRow_12);
...
if(componentRuntime_tDBRow_12 instanceof org.talend.components.api.component.runtime.SourceOrSink) {
	...
	org.talend.daikon.properties.ValidationResult vr_tDBRow_12 = sourceOrSink_tDBRow_12.validate(container_tDBRow_12);
...
class DeleteFoldertFileDelete_1{
    ...
    java.io.File file_tFileDelete_1=new java.io.File(context.StoragePath+"/"+globalMap.get("TableName")+"/out.json");
	...
	globalMap.put("tFileDelete_1_DELETE_PATH",context.StoragePath+"/"+globalMap.get("TableName")+"/out.json");
...
org.talend.components.jdbc.tjdbcinput.TJDBCInputProperties props_tDBInput_2 =
        (org.talend.components.jdbc.tjdbcinput.TJDBCInputProperties) def_tDBInput_2.createRuntimeProperties();
 		                    ...
 		                    "REMOVE @~/"+globalMap.get("TableName")+"_JSON/out.json.gz");
 		                    ...
 		                    props_tDBInput_2.main.setValue("schema",
 		                        new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"tJDBCInput_10\",\"fields\":[],\"di.table.name\":\"tJDBCInput_10\",\"di.table.label\":\"tJDBCInput_10\"}"));
 		                    
 		                    props_tDBInput_2.tableSelection.setValue("tablename",
 		                    "");
 		                    
 		                    props_tDBInput_2.trimTable.setValue("trim",
 		                    false);
...
topology_tDBInput_2 = org.talend.components.api.component.ConnectorTopology.NONE;
 ...
 */
    ...
    public static void main(String[] args){
        final Load_Endpoint_Regid_Map Load_Endpoint_Regid_MapClass = new Load_Endpoint_Regid_Map();

        int exitCode = Load_Endpoint_Regid_MapClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Load_Endpoint_Regid_Map.class.getClassLoader().getResourceAsStream("local_project/load_endpoint_regid_map_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Load_Endpoint_Regid_Map.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Load_Endpoint_Regid_Map");
        }
...
/************************************************************************************************
 *     303162 characters generated by Talend Open Studio for Big Data 
 *     on the June 27, 2018 12:38:48 PM IST
 ************************************************************************************************/